...
class SearchAllKostScreen extends StatefulWidget {
  ...
  const SearchAllKostScreen({super.key, this.initialQuery});
...
class _SearchAllKostScreenState extends State<SearchAllKostScreen> {
  ...
  List<Kost> get _allKosts {
    // Gabungkan semua data kost yang ada di mock.
    // (Kalau nanti pakai API, tinggal ganti sumber datanya.)
    return [...mockKosts, ...nearbyKosts];
  }
